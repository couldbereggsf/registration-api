...
public class APIResponse<T> {
    ...
    public APIResponse(T data, String message, String error, Instant now) {
        this.data = data;
    ...
    public static APIResponse<Void> success(String message) {
        return new APIResponse<>(null, message, null, Instant.now());
    }
    ...
    public static APIResponse<Void> failure(String error) {
        return new APIResponse<>(null, null, error, Instant.now());
    }
